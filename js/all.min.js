...
$("img").mousedown(function () {
  return false;
}); // document.ondragstart = noselect; document.onselectstart = noselect; function
...
function myFunction() {
  if (window.pageYOffset > sticky) {
    ...
    headerWrap.classList.add('header-wrap--mini');
  } else {
    header.classList.remove("header--fixed");
    header.style.borderBottom = "1px solid #74726A";
    headerWrap.classList.remove('header-wrap--mini');
  }
}
...
var anchors = document.querySelectorAll('.overlay-menu li');
var mainMenu = document.querySelector('.overlay');
...
function filterSelection(c) {
  var card, i;
  card = document.getElementsByClassName("portfolio__cards");
  if (c == "all") c = ""; // Добавить класс "show" (display:block) к фильтрованным элементам, и
  // извлеките класс "show" из элементов, которые не выбраны

  for (i = 0; i < card.length; i++) {
    w3RemoveClass(card[i], "show");
    if (card[i].className.indexOf(c) > -1) w3AddClass(card[i], "show");
  }
...
var pergola = document.querySelector('.pergola');
var sauna = document.querySelector('.sauna');
var kids = document.querySelector('.kids');
var text = document.querySelector('.description__text p');
var info = document.querySelector('.description-info');
var number = document.querySelector('.description-number');
var pic = document.querySelector('.description__pic img');
...
kids.addEventListener('click', function () {
  ...
  number.innerHTML = "5";
  pic.src = "./img/pic__kids.jpg";
  pic.alt = "Детская площадка";
});
var skillContainer = document.querySelectorAll('.skill__menu');
var skillBtns = document.getElementsByClassName('skill__item');
...
var bubble = document.querySelector('.card__description');
...
$(document).click(function (e) {
  if ($(e.target).is('.card__description')) {
    bubble.style.display = "none";
    document.body.classList.remove('overflow-hidden');
  }
});
